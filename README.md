...
<a href="https://dl-danoniplus.qu7-52m.workers.dev/danoniplus/latest/archive.zip">
  <svg xmlns="http://www.w3.org/2000/svg" width="220" height="32">
    <rect rx="6" width="220" height="32" fill="#2ea44f" />
    <path fill="#fff" d="M16 22l-6-6h4V8h4v8h4l-6 6zm-6 2h12v2H6v-2z" transform="translate(4, 0)" />
    <text x="40" y="21" fill="#fff" font-family="sans-serif" font-size="14" font-weight="bold">Download (Latest / zip)</text>
  </svg>
</a>
